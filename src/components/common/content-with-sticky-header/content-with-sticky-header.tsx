...
type ContentWithStickyHeaderProps = {
  ...
  export default function ContentWithStickyHeader({ title, children, backPath }: ContentWithStickyHeaderProps) {
      return (
          <div className="w-full min-h-full flex flex-col items-center justify-center gap-8">
                ...
                <div className="fixed bottom-0 left-0 bg-white w-full p-4 flex justify-end">
